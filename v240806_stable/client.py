...
if __name__ == "__main__":
    url = get_url('192.168.0.10', '18042')
    path = search_files(r"C:\Users\lzero\Desktop\TSLZ\data", keyword="tong")
    for _ in tqdm.tqdm(path):
        local_image(url, _)
